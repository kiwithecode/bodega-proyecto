...
import type { Producto, Rol, SalidaForm } from '../../lib/types'
...
export const salidaVacia = (rol: Rol = 'principal'): SalidaForm => ({ producto_id: null, rol, kg: '', precio_credito: '', conserva_proveedor: true })

export function ProcesoSalidas({ salidas, onChange, productos, kgSalidas, costoNeto, costoPrincipal }: { salidas: SalidaForm[]; onChange: (s: SalidaForm[]) => void; productos: Producto[]; kgSalidas: number; costoNeto: number; costoPrincipal: number }) {
